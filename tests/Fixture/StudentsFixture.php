...
class StudentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'country' => ['type' => 'string', 'length' => 50, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'created' => '2020-04-21 16:04:25',
                'modified' => '2020-04-21 16:04:25',
            ],
        ];
        parent::init();
    }
